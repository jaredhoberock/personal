...
int main()
{
  ...
  // this should pass
  std::cout << "is_strict_weak_ordering: " << is_strict_weak_ordering(float_vec.begin(), float_vec.end(), std::less<int>()) << std::endl;
  ...
  // this should fail
  std::cout << "is_strict_weak_ordering: " << is_strict_weak_ordering(float_vec.begin(), float_vec.end(), std::less<float>()) << std::endl;
